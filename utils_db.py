...
if __name__ == '__main__':
    constructed = construct_graphs('./Data/SEED/len_200/smooth_False/1_20131027/', 'SEED', 200, 3)
    print(type(constructed), constructed.keys(), type(constructed['de']), type(constructed['alpha']))
