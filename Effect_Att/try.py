...
tr_loader = DataLoader(train_set, batch_size=args.batch_size, shuffle=args.shuffle)
test_set = MultiBandDataset(constructed_test)
te_loader = DataLoader(test_set, batch_size=args.batch_size, shuffle=args.shuffle)
