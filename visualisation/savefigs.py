...
for n in range(225):
# 加载注意力权重和 edge_index
    attention_weights = torch.load(f'/data/Anaiis/garage/vis_data/7_20131030/attn_weight_l1{band}_{n}.pt')
    edge_index = torch.load(f'/data/Anaiis/garage/vis_data/7_20131030/edge_index_l1{band}_{n}.pt')
    ...
    # plt.show()
    plt.savefig(f'/data/Anaiis/garage/figs/seed_label{label}/7_20131030/{band}_fig_{n}')
