...
constructed_train, constructed_test = split_data(constructed, test_ratio=1, random_flag=True)
...
ckpt = torch.load('/data/Anaiis/garage/SEED_noshuf/exp_19-0904_0.0_best_model.pth')
